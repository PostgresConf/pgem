module Admin
  class VenuesController < Admin::BaseController
    ...
    def venue_params
      params.require(:venue).permit(:name, :street, :postalcode, :city, :state, :country, :longitude, :latitude, :description, :website, :picture, :picture_cache, :lodgings_attributes, :conference_id)
    end
  end
end
