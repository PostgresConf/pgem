...
Rails::Generators::Commands::Base.class_eval do
  def file_contains?(relative_destination, line)
    File.read(destination_path(relative_destination)).include?(line)
  end
end

Rails::Generators::Commands::Create.class_eval do
...
Rails::Generators::Commands::Destroy.class_eval do
...
Rails::Generators::Commands::List.class_eval do
  def insert_before(file, line, stop='')
    logger.insert "#{line} into #{file}"
  end
