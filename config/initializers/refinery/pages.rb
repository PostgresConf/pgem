...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "accounts", "auth", "password", "edit", "cancel", "confirmation", "comments", "conferences", "api", "v1", "rooms", "tracks", "speakers", "events", "ahoy"]
  ...
  config.layout_template_whitelist = [:website, :websitenew]
  ...
  config.add_whitelist_elements = ["iframe", "object", "embed"]
